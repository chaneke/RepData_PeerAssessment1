...
```{r setoptions, echo=FALSE}
    opts_chunk$set(echo = TRUE,results='hide',message=TRUE)
```
...
**Total steps MEAN:**
```{r echo=FALSE}
message(round(totalStepsMean))
```
**Total steps MEDIAN:**
```{r echo=FALSE}
message(round(totalStepsMedian))
```
